...
<body>
  ...
  ?>
	...
	{
		$code =$_GET['code'];
		$query_get ="SELECT* FROM tb_categories WHERE id= $code";
	}
	?>
            ...
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" role="form" >
              <div class="row">
                <div class="col-md-6 form-group">
                 <input type="hidden" name="cateid" class="form-control" value="<?php echo $code;?>">
                  
                  <input type="text" name="catname" class="form-control"  placeholder="Menu Name" required>
                  
                </div>
                <div class="col-md-6 form-group mt-3 mt-md-0">
                  <input type="text" class="form-control" name="txtorder"  placeholder="ordering (eg: 1)" required>
                </div>
              </div>
             
              <div class="form-group mt-3">
                <textarea class="form-control" name="txtbody" rows="5" placeholder="Description" ></textarea>
                <div class="validate"></div>
              </div>
               <div class="form-group mt-3">
                
                <select class="form-select " name="cbostatus">
                  <option >Please this select menu</option>
              ...
              <div class="text-left"><button type="submit" name="btnSave" class="btn btn-primary"  >Save</button></div>
            </form>
